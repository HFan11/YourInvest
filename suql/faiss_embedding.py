...
import sys
sys.path.append("C:/Users/admin/Documents/GitHub/suql/src")
...
if __name__ == "__main__":
    ...
    embedding_store.add(
        ...
        free_text_field_name="5_day_return",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="5_day_avg_close",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="5_day_volatility",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="5_day_avg_volume",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    ...
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="10_day_return",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="10_day_avg_close",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="10_day_volatility",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="10_day_avg_volume",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    ...
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="1_month_return",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="1_month_avg_close",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="1_month_volatility",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="1_month_avg_volume",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    ...
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="6_month_return",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="6_month_avg_close",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="6_month_volatility",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="6_month_avg_volume",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    ...
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="1_year_return",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="1_year_avg_close",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="1_year_volatility",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="1_year_avg_volume",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    ...
    embedding_store.add(
        table_name="stocks",
        primary_key_field_name="_id",
        free_text_field_name="signal_line",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    ...
    # Embedding function for `age_stages`
    embedding_store.add(
        table_name="age_stages",
        primary_key_field_name="id",
        free_text_field_name="explanation",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )

    # Embedding function for `asset_preferences`
    embedding_store.add(
        table_name="asset_preferences",
        primary_key_field_name="id",
        free_text_field_name="explanation",
        db_name="cs224v",
        user="select_user",
    ...
    # Embedding function for `category_definitions`
    embedding_store.add(
        table_name="category_definitions",
        primary_key_field_name="category",  # Assuming `category` is unique for this table
        free_text_field_name="low_threshold",  # If thresholds need embedding, adjust as needed
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="category_definitions",
        primary_key_field_name="category",  # Embedding for medium thresholds
        free_text_field_name="medium_threshold",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
    embedding_store.add(
        table_name="category_definitions",
        primary_key_field_name="category",  # Embedding for high thresholds
        free_text_field_name="high_threshold",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )

    # Embedding function for `liquidity_stages`
    embedding_store.add(
        table_name="liquidity_stages",
        primary_key_field_name="id",
        free_text_field_name="explanation",
        db_name="cs224v",
        user="select_user",
    ...
    # Embedding function for `occupation_stages`
    embedding_store.add(
        table_name="occupation_stages",
        primary_key_field_name="id",
    ...
    # Embedding function for `quantitative_formulas`
    embedding_store.add(
        table_name="quantitative_formulas",
        primary_key_field_name="id",
        free_text_field_name="formula",
        db_name="cs224v",
        user="select_user",
        password="select_user",
    )
